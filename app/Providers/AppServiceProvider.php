...
class AppServiceProvider extends ServiceProvider
{
    ...
    private function composeFrontViews(): void
    {
        View::composer('front.*', function ($view): void {
            ...
            /*
             * Rubriques principales + sous-rubriques actives
             * pour le menu du site public.
             */
            ...
            /*
             * Variables disponibles dans toutes les vues front.*.
             */
            $view->with([
        ...
        View::composer(
            ...
            function ($view): void {
                ...
                $statistics = [
                    ...
                    'total_views' => (clone $articleViewQuery)
                        ->count(),
                ...
                $topArticlesQuery = Article::query()
                    ...
                    ->withCount([
                        'articleViews as period_views_count' =>
                            function ($query): void {
                                $query->where(
                                    'viewed_at',
                                    '>=',
